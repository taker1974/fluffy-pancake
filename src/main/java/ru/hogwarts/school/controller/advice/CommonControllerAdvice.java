...
public class CommonControllerAdvice extends AbstractBaseControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception e) {
        return new ResponseEntity<>(new ErrorResponse(E_CODE, SERVER_ERROR, e.getMessage()),
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException e) {
        return new ResponseEntity<>(new ErrorResponse(RTE_CODE, SERVER_ERROR, e.getMessage()),
                HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<ErrorResponse> handleNpe(NullPointerException e) {
        return new ResponseEntity<>(new ErrorResponse(NPE_CODE, SERVER_ERROR, e.getMessage()),
                HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<ErrorResponse> handleIAE(IllegalArgumentException e) {
        return new ResponseEntity<>(new ErrorResponse(IAE_CODE, SERVER_ERROR, e.getMessage()),
